...
if __name__ == "__main__":
    ...
    try:
        ...
        # checkpoint = torch.load("result/2024-01-19T01-31-06_Boost_Sat2Den_diffusion_condition/checkpoints/epoch_45.ckpt", map_location=torch.device('cpu', weights_only=False))
