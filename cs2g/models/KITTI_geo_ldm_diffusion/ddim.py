...
class DDIMSampler(object):
    ...
    def sample(self,
        ...
        samples, intermediates = self.ddim_sampling(cond_sat, cond_grd, conditioning, size,
                                                    callback=callback,
    ...
    @torch.no_grad()
    def ddim_sampling(self, cond_sat, cond_grd, cond, shape,
        ...
        for i, step in enumerate(iterator):
            ...
            outs = self.p_sample_ddim(img, cond_sat, cond_grd, cond, ts, index=index,       
    ...
    @torch.no_grad()
    def p_sample_ddim(self, x, cond_sat, cond_grd, c, t, index, repeat_noise=False, use_original_steps=False, quantize_denoised=False,
                      temperature=1., noise_dropout=0., score_corrector=None, corrector_kwargs=None,
                      unconditional_guidance_scale=1., unconditional_conditioning=None):
